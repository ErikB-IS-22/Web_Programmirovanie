...
При нажатии на кнопку вычисления процента переменная a или b делится на 100.
...
Для смены цвета фона были созданы селекторы body.light-theme и body.dark-theme, в которых прописаны цвета фона и текста. 
